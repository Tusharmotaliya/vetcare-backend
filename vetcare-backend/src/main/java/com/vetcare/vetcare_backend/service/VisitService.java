...
public class VisitService {
    ...
    public Visit saveVisit(Visit visit) {
        ...
        // Step 4: Save the visit (and prescriptions via cascade)
        Visit savedVisit = visitRepository.save(visit);

        // Step 5: Auto-deduct stock for each prescribed medicine
        // We deduct 1 unit per prescription — can be made smarter later
